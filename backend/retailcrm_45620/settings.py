"""
Django settings for retailcrm_45620 project.
...
ROOT_URLCONF = 'retailcrm_45620.urls'
...
WSGI_APPLICATION = 'retailcrm_45620.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "retailcrm_45620 API",
    "DESCRIPTION": "API documentation for retailcrm_45620 App",
    "VERSION": "v1",
}
